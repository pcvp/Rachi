...
export default function NossosPlanosSection() {
  return (
    <section className="bg-white font-sora  p-6 w-full flex flex-col text-center">
      <span className="font-semibold text-2xl">Nossos Planos</span>
      <span className="text-sm font-inter mt-1 text-gray-200">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec lacinia
        mi quis euismod ultrices.
      </span>

      <Card tipo="secundario" className="mt-6 flex flex-col">
      ...
      <Card tipo="primario" className="mt-6 flex flex-col">
